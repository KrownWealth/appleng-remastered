export const footerSections = [
  ...
  },
  {
    ...
    title: "Account",
    links: [
      { href: "/account", label: "Manage Your Apple Account" },
      { href: "https://icloud.com", label: "iCloud.com" },
    ],
  },
  {
    id: "values",
...
export const footnotes = [
  ...
  },
  {
    id: "footnote-5",
    content:
      "Battery life varies by use and configuration; see <a href='/ng/batteries/'>apple.com/ng/batteries</a> for more information.",
  },
  {
    id: "footnote-6",
    content:
      "Testing conducted by Apple August through October 2024 using preproduction 14-inch MacBook&nbsp;Pro systems with Apple&nbsp;M4, 10-core CPU, 10-core GPU, 24GB of RAM, and 1TB SSD. Wireless web battery life tested by browsing 25 popular websites while connected to Wi-Fi. Video streaming battery life tested with 1080p content in Safari while connected to Wi-Fi. Display brightness set to 8 clicks from the bottom and keyboard backlight was off. Battery life varies by use and configuration. See <a href='/ng/batteries/'>apple.com/ng/batteries</a> for more information.",
  },
  {
    id: "footnote-7",
  ...
  {
    id: "footnote-50",
    content: "Speeds are based on theoretical throughput and may vary.",
  },
  {
    id: "footnote-51",
    content: "Wi‑Fi 6E available in countries and regions where supported.",
  },
  {
    id: "footnote-52",
    content: "Port configuration varies by model.",
  },
  {
    id: "footnote-53",
    content:
      "Testing conducted by Apple in January 2024 using preproduction 15-inch MacBook&nbsp;Air systems with Apple&nbsp;M3, 8-core CPU, and 10-core GPU, and preproduction 13-inch MacBook&nbsp;Air systems with Apple&nbsp;M3, 8-core CPU, and 8-core GPU, all configured with 8GB of RAM and 256GB SSD. Testing conducted by Apple in May 2022 using preproduction 13-inch MacBook&nbsp;Air systems with Apple&nbsp;M2, 8-core CPU, 8-core GPU, 8GB of RAM, and 256GB SSD. The wireless web test measures battery life by wirelessly browsing 25 popular websites with display brightness set to 8 clicks from bottom. The Apple&nbsp;TV app movie playback test measures battery life by playing back HD 1080p content with display brightness set to 8 clicks from bottom. Battery life varies by use and configuration. See <a href='/ng/batteries/'>apple.com/ng/batteries</a> for more information.",
  },
];
